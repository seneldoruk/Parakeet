...
const posts: PostProps[] = [
  {
    user: "alice",
    text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vestibulum, augue ut euismod cursus, mi risus venenatis justo, nec pellentesque ex nulla ac est. Vivamus non nunc at elit lacinia egestas. Sed malesuada justo nec neque tincidunt, eu congue sapien iaculis. Praesent auctor dolor a erat iaculis, auctor condimentum justo semper. Suspendisse potenti. Nullam vel arcu in libero consectetur lacinia ut ut elit. Phasellus fermentum nibh a augue lacinia, eu iaculis velit rhoncus. Suspendisse et malesuada odio, eu rhoncus odio. Donec commodo tellus nec risus tempus feugiat. Sed eu libero et urna fermentum faucibus. Nulla facilisi. Nulla facilisi. Fusce id est a quam vestibulum euismod in id risus."
  },
  {
    user: "bob",
